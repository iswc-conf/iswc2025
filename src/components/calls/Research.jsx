            ...
            <div className="flex justify-start items-start flex-col pt-10 pb-0 lg:pt-16 lg:pb-4 mb-4 lg:my-6 lg:h-auto lg:px-32 px-8 overflow-visible">
                ...
                <div className="text-md lg:text-lg font-[300] lg:mx-10 sm:mx-2 overflow-auto">
                    ...
                    <ul className="list-disc ml-16 text-md lg:text-lg font-[300]">
                        ...
                        <li>Submissions must be either in PDF or HTML, formatted in the style of the Springer Publications format for Lecture Notes in Computer Science (LNCS). For details on the LNCS style, see Springer’s Author Instructions. For HTML submission guidance, please see the <a href="https://iswc2025.semanticweb.org/#/guidelines/html-submission"  target="_blank" style={{ color: '#e94607' }}>HTML submission guide</a>.</li>
