        ...
        <>
            ...
            <div className="flex justify-start items-start flex-col pt-10 pb-0 lg:pt-16 lg:pb-4 mb-4 lg:my-6 lg:h-auto lg:px-32 px-8 overflow-visible">
                ...
                <div className="text-md lg:text-lg font-[300] lg:mx-10 sm:mx-2 overflow-auto">
                    ...
                    <ul className="list-disc ml-16 text-md lg:text-lg font-[300]">
                        <li>Pre-submission of abstracts is a strict requirement.</li>
                        <li>All papers and abstracts have to be submitted electronically via <a href="https://easychair.org/conferences/?conf=iswc2025" target="_blank" rel="noopener noreferrer" style={{ color: '#e94607' }}>EasyChair</a>.</li>
                        ...
                        <li>Submissions must be either in PDF or HTML, formatted in the style of the Springer Publications format for Lecture Notes in Computer Science (LNCS). For details on the LNCS style, see <a href="https://www.springer.com/gp/computer-science/lncs/conference-proceedings-guidelines"  target="_blank" style={{ color: '#e94607' }}>Springer’s Author Instructions</a>. For HTML submission guidance, please see the <a href="https://iswc2025.semanticweb.org/#/guidelines/html-submission"  target="_blank" style={{ color: '#e94607' }}>HTML submission guide</a>.</li>
